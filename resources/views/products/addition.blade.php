    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-8 offset-2 bg-white">
                ...
                <div class="font-weight-bold text-center border-bottom pb-3 pt-3" style="font-size: 24px">商品を出品する
                    <span class="h6">
                            <a href="{{ url('/products') }}">商品画面へ</a>
                    </span>
                </div>
                ...
                <form method="POST" action="{{ route('products.store') }}" class="p-5" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-0 mt-3">
                        <button type="submit" class="btn ECS-submit">
                            出品する
                        </button>
                    </div>
                </form>
